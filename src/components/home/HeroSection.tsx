        ...
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
          ...
          <div className="grid grid-cols-3 gap-4 max-w-lg mx-auto animate-fade-in-delay-2">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">{t('hero.statHospitals')}</div>
            </div>
            <div className="text-center border-x border-border">
              <div className="text-2xl md:text-3xl font-bold text-foreground">24/7</div>
              <div className="text-sm text-muted-foreground">{t('hero.statAvailable')}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-foreground">10k+</div>
              <div className="text-sm text-muted-foreground">{t('hero.statLivesHelped')}</div>
            </div>
          </div>
        </div>
      </div>
